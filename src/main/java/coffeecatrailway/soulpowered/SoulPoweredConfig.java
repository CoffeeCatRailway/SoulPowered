...
public class SoulPoweredConfig
{
    ...
    public static class Server
    {
        ...
        public Server(ForgeConfigSpec.Builder builder)
        {
            ...
            this.canRightClickEquipCurio = builder.comment("whether you can press right-click to equip a curios item")
                    .translation(CONFIG + "curios.canRightClickEquipCurio").define("canRightClickEquipCurio", true);
